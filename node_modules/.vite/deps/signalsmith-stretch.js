...
var SignalsmithStretch = (() => {
  ...
  return (function(moduleArg = {}) {
    ...
    var crypto = (globalThis == null ? void 0 : globalThis.crypto) || { getRandomValues: (array) => {
      for (var i = 0; i < array.length; i++) array[i] = Math.random() * 256 | 0;
    } };
    var performance = (globalThis == null ? void 0 : globalThis.performance) || { now: (_) => Date.now() };
...
function registerWorkletProcessor(Module, audioNodeKey) {
  class WasmProcessor extends AudioWorkletProcessor {
    constructor(options) {
      ...
      Module().then((wasmModule) => {
        ...
        this.port.onmessage = (event) => {
          ...
          if (result == null ? void 0 : result.transfer) {
    ...
    process(inputList, outputList, parameters) {
      ...
      if (!((_a = outputList[0]) == null ? void 0 : _a.length)) return false;
      ...
      if (outputList[0].length != this.channels) {
        this.channels = ((_b = outputList[0]) == null ? void 0 : _b.length) || 0;
        configure();
      }
      ...
      } else if (inputs == null ? void 0 : inputs.length) {
        outputList[0].forEach((_, c) => {
          let channelBuffer = inputs[c % inputs.length];
          let buffer = new Float32Array(memory, this.buffersIn[c], outputBlockSize);
          if (channelBuffer) {
...
export {
  SignalsmithStretch_default as default
};
//# sourceMappingURL=signalsmith-stretch.js.map
